...
public class StatusBar extends SystemUI implements DemoMode,
    ...
    public void start() {
        ...
        mCOSPSettingsObserver.observe();
        mCOSPSettingsObserver.update();
    ...
    private COSPSettingsObserver mCOSPSettingsObserver = new COSPSettingsObserver(mHandler);
    private class COSPSettingsObserver extends ContentObserver {
        COSPSettingsObserver(Handler handler) {
            super(handler);
        }
